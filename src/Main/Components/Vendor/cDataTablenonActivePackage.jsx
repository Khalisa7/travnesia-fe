...
class CDataTablenonActivePackage extends Component{
    constructor(props){
        super(props);
        this.state = {
            data : [],
        ...
        return(
            <div>
                <div className="row justify-content-end mb-3">
                    ...
                    <a href='/partner/product/add' className='btn btn-danger'>
                            ...
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col-md-3">
                                        ...
                                        <h5><span className="badge badge-danger text-white">Non-Active</span></h5>
                                    </div>
                                    <div className="col-md-3">
...
export default CDataTablenonActivePackage;