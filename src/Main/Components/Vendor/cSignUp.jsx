...
class CSignUp extends Component {
  ...
  handleValidation() {
    ...
    if (!fields['company_name']) {
      isValid = false
      invalid['company_name'] = 'is-invalid'
      errors['company_name'] = "Nama Perusahaan tidak boleh kosong"
    }
                      ...
                      <div className="form-row">
                        ...
                        <div className="form-group col-md-12">
                          ...
                          <div className="input-group">
                            ...
                            <input
                              type="text"
                              className={'form-control ' + this.state.invalid["company_name"]}
                              placeholder="Nama Perusahaan"
                              name="company_name"
                              onChange={this.handleChange.bind(this, 'company_name')}
                            />
                          </div>
                          <small className="text-danger">{this.state.errors["company_name"]}</small>
                        </div>
                        <div className="form-group col-md-12">
