...
import CSignUp from "../../Components/Public/cSignUp";
...
import MSignUp from "../../MobileComponent/Public/mSignUp";
import MHeader from "../../MobileComponent/Public/mHeaderPrevious";

class PVendorSignUp extends Component {
  componentDidMount() {
