...
import './../Public/style/sMobileSignUp.css'
...
class CSignUp extends Component {
    ...
    handleSubmit(event) {
        ...
        if (!this.state.gcaptcha) {
            ...
            this.Auth.register(
                this.state.username, this.state.password, this.state.confpassword, this.state.firstname, this.state.lastname, this.state.company_name
            )
                .then(res => {
                                ...
                                <div className='card-body bg-white'>
                                    ...
                                    <form onSubmit={this.handleSubmit}>
                                        <div className='form-row'>
                                            ...
                                            <div className='form-group col-md-12'>
                                                <label htmlFor=''>{this.lang.signup_company_name}</label>
                                                <div className='input-group'>
                                                    <div className='input-group-prepend'>
                                                        <span className='input-group-text primary-color'>
                                                            <i className='fa fa-fw fa-user f-white' />
                                                    ...
                                                    <input
                                                        ...
                                                        required
                                                        onChange={(ev) => this.setState({ company_name: ev.target.value })}
                                                    />
                                                </div>
                                            </div>
                                            <div className='form-group col-md-12'>
